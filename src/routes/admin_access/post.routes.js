...
router.post("/masters", [user_validator_1.checkUserName, user_validator_1.checkDuplicateEmail], masterController.create);
router.post("/users", [user_validator_1.checkDuplicateEmail, user_validator_1.checkUserName, user_validator_1.checkUserPassword], userController.create);
