...
const clockTypeController = __importStar(require("../../controllers/clockType"));
...
router.get('/access/user', [verifyTokenAndExtractUserId_1.default], authController.userAccess);
