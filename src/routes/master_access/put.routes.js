...
const ifOrderBelongToMaster_1 = __importDefault(require("../../validators/ifOrderBelongToMaster"));
const roles_validator_1 = require("../../validators/roles.validator");
const router = (0, express_1.Router)();
router.use(ifBodyUndefined_1.default);
router.put("/master/orders/:id", [verifyTokenAndExtractUserId_1.default, roles_validator_1.isMaster, ifOrderBelongToMaster_1.default], orderController.update);
